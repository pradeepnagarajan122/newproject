...
import React, { useState } from "react";
import "./EmploymentInfo.css"; // Link to the responsive styles
...
const EmploymentInfo = (props) => {
  ...
  return (
    ...
    >
      <h2 className="form-title">Employment Information Form</h2>
      ...
      <div className="button-group">
        <button onClick={AcademicInfo} className="button-previous">
          Previous
        </button>
