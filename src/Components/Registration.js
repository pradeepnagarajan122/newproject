...
import { useState } from "react";
import { Link } from "react-router-dom";
import "./Registration.css"; // Link to the responsive CSS file
...
const Registration = (props) => {
  ...
  return (
    <div className="form-container">
      <h2 className="form-title">Course Registration Form</h2>
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          <label htmlFor="registrationDate">Date of Registration:</label>
          <input
        ...
        <div className="button-group">
          <button onClick={EmploymentInf} className="button-previous">
            Previous
          </button>
